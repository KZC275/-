...
export default {
  ...
  data () {
    return {
      msg: 'Welcome',
      timer_ac:null,
      arrList:[{text:123},{text:456},{text:66},{text:123},{text:66666},{text:456},{text:66},{text:123},{text:66666},{text:456},{text:66},{text:123},{text:'大师傅似的'},{text:456},{text:'gdfg'},{text:'sdsds'},{text:'asdas'}]
    }
        ...
        var obj = {
          ...
          isDot: function(params,num) {
            ...
            if($('.dot_wrapper')[0]){
              ...
              $('.dot_wrapper em').eq(num).css('background-color', 'purple');
              return false;
            }
